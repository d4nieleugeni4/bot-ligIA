...
// Novas funções adicionadas para suporte a botões
exports.sendButtonMessage = async ({ socket, remoteJid, text, buttons, mentions }) => {
  try {
    const buttonMessage = {
      text,
...
exports.sendReply = async ({ socket, remoteJid, text, mentions }) => {
